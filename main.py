    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        if "basic_cleaning" in active_steps:
            ...
            _ = mlflow.run(
                ...
                docker_args={
                    "v": f"{basic_cleaning_path}:/mlflow/projects/code",
        ...
        if "train_random_forest" in active_steps:
            ...
            train_random_forest_path = os.path.join(
                hydra.utils.get_original_cwd(), "src", "train_random_forest")
            # NOTE: we need to serialize the random forest configuration into JSON
            # To make it work inside mounted docker container, we save json in the component directory instead of tmp directory
            ...
            _ = mlflow.run(
                ...
                docker_args={
                    "v": f"{train_random_forest_path}:/mlflow/projects/code",
                    "e": f"WANDB_API_KEY={os.getenv('WANDB_API_KEY')}"
                }
            )
